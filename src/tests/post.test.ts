...
import {getCookieSetters, setupDifferentUsersPosts, setupMultipleUsersForTests, setupSameUserPosts,} from "./utils";
    ...
    describe("With posts created by different users", () => {
        ...
        describe("Search posts", () => {
            it("should return relevant posts based on search query with correct enrichment", async () => {
                ...
                expect(post).toMatchObject(POSTS[0]);
